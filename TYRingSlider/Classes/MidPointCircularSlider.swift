...
open class MidPointCircularSlider: RangeCircularSlider {
    ...
    override open func draw(_ rect: CGRect) {
        ...
        let startAngle = TYRingSliderHelper.scaleToAngle(value: startPointValue, inInterval: valuesInterval) + TYRingSliderHelper.circleInitialAngle
        ...
        let midAngle = TYRingSliderHelper.scaleToAngle(value: midPointValue, inInterval: valuesInterval) + TYRingSliderHelper.circleInitialAngle
