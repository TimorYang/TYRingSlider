 ...
 */
open class RangeCircularSlider: TYRingSlider {
    ...
    */
    ...
    override open func draw(_ rect: CGRect) {
        ...
        let startAngle = TYRingSliderHelper.scaleToAngle(value: startPointValue, inInterval: interval) + TYRingSliderHelper.circleInitialAngle
        // get end angle from end value
        let endAngle = TYRingSliderHelper.scaleToAngle(value: endPointValue, inInterval: interval) + TYRingSliderHelper.circleInitialAngle
        ...
        endThumbCenter = drawThumbAt(endAngle, with: endThumbImage, inContext: context, followAngle: true)
        ...
        startThumbCenter = drawThumbAt(startAngle, with: startThumbImage, inContext: context, followAngle: true)
    }
