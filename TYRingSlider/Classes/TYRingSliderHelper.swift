...
//            }
    ...
    internal static func arePointsTouchingOnSameCircle(point: CGFloat, targetPoint: CGFloat, movementDirection:MovementDirection, interval: Interval, isCrossDay: Bool) -> CGFloat {
//        return false
        var result: CGFloat!
